/**
 * @api {get} /parcel/driver?userId=8848484&page=1 Get all drivers parcels
 * @apiName Get-Driver-Parcel
 * @apiGroup Parcel
 * @apiVersion  1.0.0
 * @apiSampleRequest off
 *
 * @apiParam {string} userId ID of the parcel user
 * @apiParam {string} page the page cusor for pagination
 *
