/**
 * @api {GET} /admin/drivers/search?searchQuery=kd9di Search for a driver
 * @apiName Searching Driver
 * @apiGroup Admin
 * @apiVersion  1.0.0
 ...
 * @apiSuccess {Array} payload Array containing search result of drivers
