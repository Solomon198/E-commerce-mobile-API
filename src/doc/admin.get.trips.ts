/**
 * @api {get} /admin/deliveries?userId=8848484&status=3&isDriver=false Get all completed or cancelled deliveries for drivers or user
 ...
 * @apiParam {boolean} isDriver specify if the account to fetch is a driver or user account
 * @apiParam {string} userId specify id of driver or user
 *
